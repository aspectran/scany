 ...
 */
public class RemoteServiceRuleNodeletAdder implements EasyNodeletAdder {
	...
	public void process(String xpath, EasyNodeletParser parser) {
		parser.addNodelet(xpath, "/remote", new EasyNodelet() {
		...
		parser.addNodelet(xpath, "/remote/schema", new EasyNodelet() {
			public void process(Properties attributes, String text) throws Exception {
				RemoteServiceRule rsr = (RemoteServiceRule)assistant.peekObject();
				rsr.setSchemaConfigLocation(text);
			}
		});
		parser.addNodelet(xpath, "/remote/characterEncoding", new EasyNodelet() {
			public void process(Properties attributes, String text) throws Exception {
				RemoteServiceRule rsr = (RemoteServiceRule)assistant.peekObject();
				rsr.setCharacterEncoding(text);
			}
		});
		parser.addNodelet(xpath, "/remote/connection/host", new EasyNodelet() {
			public void process(Properties attributes, String text) throws Exception {
		...
		parser.addNodelet(xpath, "/remote/connection/timeout", new EasyNodelet() {
			public void process(Properties attributes, String text) throws Exception {
		...
		parser.addNodelet(xpath, "/remote/message/keysign", new EasyNodelet() {
			public void process(Properties attributes, String text) throws Exception {
		...
		parser.addNodelet(xpath, "/remote/message/body", new EasyNodelet() {
			public void process(Properties attributes, String text) throws Exception {
				String encryption = attributes.getProperty("encryption");
				String compressable = attributes.getProperty("compressable");
		...
		if(xpath.endsWith("/scany/client")) {
			parser.addNodelet(xpath, "/remote/end()", new EasyNodelet() {
				public void process(Properties attributes, String text) throws Exception {
