 ...
 ******************************************************************************/
package org.jhlabs.scany.config;

import org.jhlabs.scany.analysis.bigram.BigramAnalyzer;
import org.jhlabs.scany.analysis.csv.CSVAnalyzer;
import org.jhlabs.scany.analysis.syllabic.SyllabicAnalyzer;
...
public class ScanyConfig {
	...
	private Analyzer getAnalyzer(String analyzerName) {
		...
		if(analyzer == null) {
			try {
				...
				throw new ScanyConfigException("외부 분석기(Analyzer) 생성에 실패했습니다. (" + analyzerName + ")", e);
			}
		}
	...
	*/
	 ...
	 * @throws CommonException
	 */
	public MultipleXReader.Record loadClientConfig(InputStream is, String serviceName) throws ScanyConfigException {
		String[] columnNames = {
				"ScanyHome",
				"RopositoryHome",
				"ScanyHome",
		...
		try {
			...
			throw new ScanyConfigException("Scany Client 설정정보를 읽을 수 없습니다.", e);
		}
	}
	 ...
	 * @throws CommonException
	 */
	public Map loadSchemas(String schemasXml, String repositoryHome) throws ScanyConfigException {
		String[] columnNames = {
				"KeyPattern",
				"Repository",
				"Description",
...
//					System.out.println(schema.getRepository());
			...
			throw new ScanyConfigException("Scany 스키마 설정정보를 불러 올 수 없습니다.", e);
		}
	}
